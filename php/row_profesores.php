                    ...
                    foreach ($profesores as $profe) { ?>
                        ...
                        <tr>
                            ...
                            <?php
                                if ($profe["creador"] != 1) {
                                ?>
                                  <button type="button" class="btn btn-outline-danger" onclick="window.location.href='crude/profesor_acta/profesoresDeActas_eliminar.php? ida=<?php echo $profe['acta_id']?>& idp=<?php echo $profe['profe_id'] ?>'">
